...
const DJANGO_API_URL = process.env.REACT_APP_API_URL || 'http://172.168.1.95:8052/api';
const ORCHESTRATOR_URL = process.env.REACT_APP_ORCHESTRATOR_URL || 'http://172.168.1.95:3057/api';
